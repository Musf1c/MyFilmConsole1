...
public class Application {
    ...
    public Application() {
        listUser = FileUtils.readFileUser( "src\\users1");
        filmRatingList = FileUtils.readFileFilmRating( "src\\ListFilmRating");
        listFilm = FileUtils.readFileFilm( "src\\film1", filmRatingList);
        personalFilmList = FileUtils.readFilePersonalFilm( "src\\PersonalFilm");
